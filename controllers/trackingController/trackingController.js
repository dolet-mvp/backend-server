...
const updateOnTheWay = async (req, res) => {
  try {
    ...
    // Notify helpseeker - Notifications when helper marks on the way
...
const markArrived = async (req, res) => {
  try {
    ...
    // Notify helpseeker -Notifications when helper marks arrived
    await createNotification({
      userId: task.helpseekerId,
      userType: 'helpseeker',
      taskId: task.id,
...
const completeWork = async (req, res) => {
  try {
    ...
    // Notify helpseeker - Notifications when helper completes task
    await createNotification({
      userId: task.helpseekerId,
      userType: 'helpseeker',
      taskId: task.id,
